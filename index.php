...
<head>
  ...
  <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
    ...
    <body>
      ...
      <div class="col-md-4 col-md-offset-4"><?php echo flash();?></div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <p><a class="btn t-btn-default" href="#" role="button">View details &raquo;</a></p>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <footer>
            <p>&copy; E-asy Gest <?php echo date('Y'); ?></p>
          </footer>
        </div> <!-- /container -->
