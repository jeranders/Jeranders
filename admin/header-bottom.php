                          ...
                          <div class="nano">
                            <div class="nano-content">
                              <ul class="notification-dropdown">
                                <?php 
                                $n_historique = $bdd->query('SELECT * FROM historiques ORDER BY h_date DESC LIMIT 0, 10'); 
                        ...
                        <aside class="user-menu"> 
                          ...
                          <div class="tabs-offcanvas">
                            ...
                            <div class="responsive-admin-menu">
                              ...
                              <ul id="menu">
                                <li><a  href="#" title="Dashboard" data-id="dash-sub"><i class="entypo-briefcase"></i><span> Dashboard</span></a>  </li>
