    ...
    <div class="main-wrap"> 
      ...
      <div class="content-wrapper"> 
        ...
        <div class="page-header">
          <h1>Clear<small>Start Page</small></h1>
        </div>
        ...
        <div class="row" id="powerwidgets">
          <div class="col-md-12 bootstrap-grid"> 
            ...
            <div class="powerwidget blue" id="startwidget">
              <header>
                <h2>Clear Widget<small>Start!</small></h2>
              </header>
              <div>
                ...
                <div class="inner-spacer">Add Content and Start with Widget</div>
              </div>
            </div>
            <!-- End Widget --> 
